...
# Kernel defconfig
export RK_KERNEL_DEFCONFIG=firefly-rk3308_linux_defconfig
# Kernel dts
export RK_KERNEL_DTS=rk3308-roc-cc-dmic-pdm_emmc
# boot image type
...
#build info
export PRODUCT_UI=NoUi
export RK_MODEL=ROC-RK3308-CC
