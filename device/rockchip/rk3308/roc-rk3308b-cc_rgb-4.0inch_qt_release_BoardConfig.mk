...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=firefly-rk3308-logo
# Kernel defconfig
export RK_KERNEL_DEFCONFIG=firefly-rk3308b_linux_defconfig
# Kernel dts
export RK_KERNEL_DTS=rk3308b-roc-cc-amic-rgb_4.0inch_emmc
# boot image type
...
#userdata config
export RK_USERDATA_DIR=userdata_qt
MIC_NUM=6
#misc image
...
#build info
export PRODUCT_UI=Qt-rgb_4.0inch
export RK_MODEL=ROC-RK3308B-CC
export RK_VERSION=$(echo $RK_MODEL)-$(echo $PRODUCT_UI)-$(date +"%Y%m%d")
export RK_OTA_HOST=

#choose rkbin/RKBOOT/ *.ini file to pack loader image
export RK_RKBOOT_INI=RK3308MINIALL

export RK_LOADER_NAME=*_loader_v*.bin
