...
void ThumbImageWidget::initLayout()
{
    ...
    m_controlBottom->setBackgroundColor(0, 127, 255);
    ...
    BaseWidget::setWidgetFontSize(m_imageCountText, font_size);
    m_imageCountText->adjustSize();

    m_bottomSeleteTitle = new QLabel(this);
    BaseWidget::setWidgetFontSize(m_bottomSeleteTitle, font_size);
