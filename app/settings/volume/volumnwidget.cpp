...
#ifdef DEVICE_EVB
int volumButton_size = 60;
#else
int volumButton_size = 30;
#endif
    ...
    ui(new Ui::VolumnWidget)
{
    ...
    ui->m_VolumnDownPushButton->setIconSize(QSize(volumButton_size, volumButton_size));
    ui->m_VolumnDownPushButton->setIcon(QIcon(QPixmap(":/image/setting/volume-down.png")));
    ui->m_VolumnUpPushButton->setIconSize(QSize(volumButton_size, volumButton_size));
