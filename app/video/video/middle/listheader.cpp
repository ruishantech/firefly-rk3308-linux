...
void FuntionButton::initWidget()
{
    ...
    BaseWidget::setWidgetFontSize(m_title, font_size);
    ...
    m_bottomLine->setStyleSheet("QFrame{border:1px solid rgb(0,0,0,255);}");
...
{
    m_title->setStyleSheet("color:rgb(0,0,0);");
    update();
}
...
void FuntionButton::setFousedStyle()
{
    m_isCurItem = true;
    m_title->setStyleSheet("color:rgb(0,0,0);");
    m_bottomLine->setStyleSheet("QFrame{border:1px solid rgb(0,0,0);}");
