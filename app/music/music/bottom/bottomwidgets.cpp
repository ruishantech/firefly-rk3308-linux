...
#else
int playButton_size = 40;
int bottom_height = 70;
int bottom_spacing = 15;
int layout3_size = 40;
int layout3_temp = 10;
...
#else
    BaseWidget::setWidgetFontSize(m_labPosition, font_size_big);
#endif
