...
FFMPEG4_CONF_OPTS += --enable-debug
else
FFMPEG4_CONF_OPTS += --disable-debug
endif

ifeq ($(BR2_PACKAGE_FFMPEG_SMALL),y)
FFMPEG4_CONF_OPTS += --enable-small
else
FFMPEG4_CONF_OPTS += --disable-small
endif
...
FFMPEG4_CONF_OPTS += --enable-librga
FFMPEG4_DEPENDENCIES += linux-rga
else
FFMPEG4_CONF_OPTS += --disable-librga
endif
...
FFMPEG4_CONF_OPTS += $(foreach x,$(call qstrip,$(BR2_PACKAGE_FFMPEG_DISABLE_DECODERS)),--disable-encoder=$(x))
endif
...
FFMPEG4_CONF_OPTS += --enable-libion
FFMPEG4_DEPENDENCIES += libion
endif
endif
...
FFMPEG4_DEPENDENCIES += mpp libion
FFMPEG4_CONF_OPTS += --enable-rkmpp --extra-cflags="-D CONFIG_ION"
else
FFMPEG4_DEPENDENCIES += mpp libdrm
FFMPEG4_CONF_OPTS += --enable-rkmpp --enable-libdrm
endif
...
FFMPEG4_CONF_OPTS += --disable-rkmpp
endif
